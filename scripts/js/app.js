...
function setupSticky() {
    var header = document.getElementById("auto_gen_id_unq_6");
    if (header instanceof HTMLElement) {
        var sticky_1 = header.offsetTop;
        var myFunction = function () {
            if (window.scrollY > sticky_1) {
